<template>
  <div class="self-help">
    <div class="title" >
      <h3 style="padding: 10px;display: inline-block">自助机操作日志</h3>

      <ul>
        <li>
          <span>自助机编号：</span>
          <el-select v-model="self_number" placeholder="请选择" size="mini" style="width: 150px;">
            <el-option
        ...
        <li>
          <span>操作人：</span>
          <el-select v-model="operate_people" placeholder="请选择" size="mini" style="width: 150px;">
            <el-option
