  ...
  export default {
    ...
    data() {
      return {
        ...
        refresh_flag : true,
        //url
        url: 'price.crowncrystalhotel.com/v1',
        //parent_id 隐藏
        maskparent: false,
        //扩展的li
        maskextendli: false,
    ...
    methods: {
      ...
      select_info: function(flag_char) {
        ...
        if(flag_char === 'category') {
          //分类  需要更改接口的地方
          urlData = "http://code.crowncrystalhotel.com/v1/system/settings/get_code_base_list/?parent_code=ratecode_categroy&page_size=100"
          that.fatherData({
            url: urlData
          }).then((res) => {
            console.info(res);
          ...
          //市场码
          urlData = 'http://code.crowncrystalhotel.com/v1/system/settings/get_code_base_list/?parent_code=market_code&page_size=100';
          that.fatherData({
            url: urlData
          }).then((res) => {
          ...
          //来源码
          urlData = 'http://code.crowncrystalhotel.com/v1/system/settings/get_code_base_list/?parent_code=src_code&page_size=100';
          that.fatherData({
            url: urlData
          }).then((res) => {
          ...
          //入账代码
          urlData = 'http://code.crowncrystalhotel.com/v1/system/settings/get_code_transaction_list/';
          ...
          //引用id
          urlData = 'http://price.crowncrystalhotel.com/v1/rate_code/get_rate_code_list/';
          that.maskextendli = true;
          that.fatherData({
            url: urlData
          }).then((res) => {
      ...
      handleClick(val) {
        ...
        that.$axios({
          ...
          that.$axios({
              method : 'post',
              url : 'http://price.crowncrystalhotel.com/v1/rate_code/get_rate_code/',
              data : {
                rate_code : val.code,
