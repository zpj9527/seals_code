    ...
    <div class="storedList">
        ...
        <div class="mid_section">
            ...
            <div class="pull-right mid_right">
                ...
                <div class="inputItems">
                    <p>持卡人：</p>
                    <el-input v-model=" memberData.name " size="mini" placeholder="请输入内容" style="width: 60%;" ></el-input>
                </div>
                <div class="inputItems">
                    <p>协议计划：</p>
        ...
        <!-- 第一次进入如果没有携协议信息 --> 
        <el-dialog title="协议选择" :visible.sync=" checkdialogVisible " width="70%">
            <div class="charge_detail">  
                ...
                <div class="table" style="width: 100%;">
                    ...
                    <tbody>
                        <tr  v-for="(item,index) in memberList" :key="index" @click="get_memberData(item,index)" :style="{ 'background-color':index == memberData_index? '#bbbbbb':''}">
                        <td>{{ item.id }}</td>
                        <td>{{ item.name }}</td>
                        <td>{{ item.card_no }}</td>
        ...
        <el-dialog title="储值卡充值" :visible.sync=" chargedialogVisible " width="40%">
            <div class="charge_detail">
                ...
                <div class="charge_left pull-left">
                    ...
                    <div class="Items">
                        <p></p>
                        <el-input type="textarea" size="mini" resize='none' :value="'单位名称：'+ memberData.name " style="width: 60%;" :autosize="{ minRows: 4, maxRows: 6}"></el-input>
                    </div>
                </div>
                <!-- 右部 -->
        ...
        <el-dialog title="储值转移明细" :visible.sync="exchangedialogVisible" width="50%">
            <div class="charge_detail">
                ...
                <div class="charge_left pull-right" style="width: 33%;">
                    ...
                    <div class="Items">
                        <p></p>
                        <el-input type="textarea" size="mini" resize='none'  :value="'单位名称：' + exchange_form.card_name " style="width: 60%;" :autosize="{ minRows: 4, maxRows: 6}"></el-input>
                    </div>
                </div>
        ...
        <!-- 卡查询 --> 
        <el-dialog title="协议单位查询" :visible.sync=" searchdialogVisible " width="70%">
            <div class="charge_detail"> 
                <!-- 左部 -->
                <div class="">
                    <div class="Items">
        ...
        <el-dialog title="储值卡发票明细" :visible.sync=" detaildialogVisible " width="70%">
            <div class="charge_detail"> 
                    <el-table :data="invoiceTableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange" border height="300" :header-cell-style="{background:'#68819E',color:'#fff'}">
                        ...
                        <el-table-column prop="card_no" label="协议卡号" > 
                        </el-table-column>
...
export default {
    ...
    methods:{
        ...
        get_card_deposit_list(){
            let that = this, url = that.UrLHeader + 'customer/company/get_company_deposit_list/';
        ...
        /* 充值相关函数 */ 
        add_card_deposit(){
            let that = this, url = that.UrLHeader + 'customer/company/add_company_deposit/',
            params = {
                "company_id": that.memberData.id,
        ...
        consume_card_deposit(){
            ...
            if(avaMoney>(parseFloat(that.consume_form.amount))){
                ...
                }).catch((error)=>{ that.$message.error('消费失败!') }) 
            }else{
        ...
        exchange_card_deposit(){
            ...
            console.log(that.memberData.iss_hotel);
            let avaMoney =  that.memberData.money_pay -  that.memberData.money_charge -  that.memberData.money_freeze ;
            if(avaMoney>(parseFloat(that.consume_form.amount))){
                ...
                if(that.exchange_form.transfer_card_id){
                    ...
                    }).catch((error)=>{ that.$message.error('转账失败!') }) 
                }else{
                    that.$message({
                        message: "请选择输入卡的卡号",
                        type: "info"
        ...
        that.$axios .get(url) .then(function(res) {
            console.log('协议列表',res.data.data);
            if (res.data.message == "success") {
        ...
        check_card_confirm(){
            ...
            if(that.certain_member_data.card_no && that.certain_member_data.id){
                ...
                that.exchange_form.card_name =  that.certain_member_data.name;
        ...
        get_card_invoice_detail_list(){
            let that = this, url = that.UrLHeader + 'customer/company/get_company_invoice_detail_list/?page_size=30';
        ...
        handleCurrentPageChange(currentPage) { 
            let that = this, url = that.UrLHeader + 'customer/company/get_company_deposit_list/?page='+ currentPage + '&page_size='+10,
            params = {
                "company_id": that.memberData.id
            };
