            ...
            <el-dialog
              ...
              <div class="innerDialog">
                ...
                <div class="inputCell">
                    ...
                    <el-select v-if=" ExtraItemJson.extra_item ==  'rate_code'" v-model="ExtraItemJson.extra_item_value" placeholder="请选择" style="width: 60%;" @focus="get_rate_code_data()">
                      <el-option
                    ...
                    <el-input v-else v-model="ExtraItemJson.extra_item_value" placeholder="请输入内容" style="width: 60%;"></el-input>
                </div>
                <div class="inputCell">
          ...
          update_card_level_extra(id){
            ...
            if(!_this.isnull(_this.ExtraItemJson.extra_item)){
              ...
              if(!_this.isnull(_this.ExtraItemJson.extra_item_value)){
                let params = {
                  date_begin: _this.ExtraItemJson.date_begin,
                  date_end: _this.ExtraItemJson.date_begin,
                  extra_item: _this.ExtraItemJson.extra_item,
                  extra_item_value: _this.ExtraItemJson.extra_item_value,
                  is_halt: _this.ExtraItemJson.is_halt
                } 
                axios.post(
