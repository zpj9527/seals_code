  ...
  <div class="ironsteward">
    <el-container>
      ...
      <el-aside  class="left"  style="width: 350px">
        ...
        <el-tree :data="equipment_type_tree" :props="defaultProps" @node-click="handleNodeClick"></el-tree>
        <!-- 添加最外层按钮 -->
      ...
      <el-main  class="right" >
        <el-card class="box-card">
            ...
            <div class="switchSec">
              主灯:
              <el-switch v-model="majorLight" active-color="#4488E9" inactive-color="#eee"> </el-switch>
            </div>
            ...
            <div class="switchSec">
              电视:
              <el-switch v-model="majorLight" active-color="#4488E9" inactive-color="#eee"> </el-switch>
              <p style="width: 60px;display: inline-block;margin-left: 50px;">启动视频:</p> 
              <el-select  filterable placeholder="请选择" style="width: 250px;"  size="mini" >
                <el-option v-for="(item,index) in tableData" :key="index" :label="item.descript" :value="item.code" ></el-option>
            </el-select>
            </div>
            ...
            <div class="switchSec">
              空调:
              <el-switch v-model="majorLight" active-color="#4488E9" inactive-color="#eee"> </el-switch> 
              <p style="width: 60px;display: inline-block;margin-left: 50px;">模式:</p>
              <el-select  filterable placeholder="请选择" style="width: 250px;"  size="mini" >
                <el-option v-for="(item,index) in tableData" :key="index" :label="item.descript" :value="item.code" ></el-option>
            </el-select>
 
              <p style="width: 60px;display: inline-block;margin-left: 50px;">温度:</p>
              <el-select  filterable placeholder="请选择" style="width: 250px;"  size="mini" >
                <el-option v-for="(item,index) in tableData" :key="index" :label="item.descript" :value="item.code" ></el-option>
            </el-select>


            <p style="width: 60px;display: inline-block;margin-left: 50px;">风速:</p> 
            <el-select  filterable placeholder="请选择" style="width: 250px;"  size="mini" >
                <el-option v-for="(item,index) in tableData" :key="index" :label="item.descript" :value="item.code" ></el-option>
            </el-select>
            </div>
            ...
            <div class="switchSec">
              ...
              <p style="width: 60px;display: inline-block;margin-left: 50px;">启动音乐:</p> 
