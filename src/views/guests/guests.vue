              ...
              <div class='rightNav'>
                ...
                <ul class='nav_section'>
                    <li class="">
                      <!-- <i class="color_red">*</i> -->
                      <p> 手机：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.mobile " clearable></el-input>
                    </li>
                    <li class="">
                      <p>地址：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.addr_name " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>州/省：</p>
                      <!-- <el-input placeholder="请输入内容" size='small' v-model=" guestJson.state " clearable></el-input> -->

                      <el-select v-model=" guestJson.state " size='small' filterable placeholder="请选择" >
                        <el-option v-for="(item,index) in provinceArr" :key="index" :label="item.descript" :value="item.code" ></el-option>
                      </el-select>
                    </li>
                    <li class=" ">
                      <p>电话：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.phone " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>类型：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.addr_type  " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>行政区域：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.division " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>邮箱：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.email  " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>国家：</p>
                      <!-- <el-input placeholder="请输入内容" size='small' v-model=" guestJson.country  " clearable></el-input> -->
                      <el-select v-model=" guestJson.country " size='small' filterable placeholder="请选择" >
                        <el-option v-for="(item,index) in countryArr" :key="index" :label="item.descript" :value="item.code" ></el-option>
                      </el-select>
                    </li>
                    <li class=" ">
                      <p>邮编：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.zipcode  " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>传真：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.fax " clearable></el-input>
                    </li>
                    <li class=" ">
                      <p>城市：</p>
                      <!-- <el-input placeholder="请输入内容" size='small' v-model=" guestJson.city  " clearable></el-input> -->
                      <el-select v-model=" guestJson.city " size='small' filterable placeholder="请选择" >
                        <el-option v-for="(item,index) in cityArr" :key="index" :label="item.descript" :value="item.code" ></el-option>
                      </el-select>
                    </li>
                    <li class=" ">
                      <p>街道：</p>
                      <el-input placeholder="请输入内容" size='small' v-model=" guestJson.street " clearable></el-input>
                    </li>
                </ul>
  ...
  methods: {
    ...
    add_card_base() {
      ...
      if(!that.isnull(guest_base.name)){
        ...
        // if(that.phone_reg.test(guest_base.mobile)){
          that.$axios({
              url: url,
              method: "post",
              data: {
            ...
            console.log(res.data);
              if (res.data.message == "success") {
                ...
                that.get_certain_list(res.data.data.id);
                that.$message({
                  message: "添加成功",
                  type: "success"
                });
