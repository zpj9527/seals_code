...
<div class="IntegralList">
  ...
  <div class="search">
      ...
      <div class="inputCell">
        持卡人 ：
        <!-- 查询input -->
        <el-input v-model=" memberData.card_name " placeholder="请输入内容" style="width: 200px;margin: 0 16px;"></el-input>
      </div>
      <div class="inputCell">
        会员计划：
        <!-- 查询input -->
...
export default {
    ...
    methods: {
      ...
      /* 获取积分列表 */
      get_point_list(){
        let that = this, url = that.UrLHeader + 'customer/member/get_card_point_list/';
