<template>
  <div class="MemberPlan">
      ...
      <!-- 会员计划外层dialog -->
      <el-dialog title="编辑" :visible.sync="outerVisible" width="80%">
            <div class="outdialog">
              ...
              <div class="classMes" style="padding: 10px 20px;">
                <div class="pull-left" style="width: 80%;">
                  <div class="inputCell" style="width: 24%;">
                    ...
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.code" placeholder="请输入内容" style="width: 50%;"></el-input>
                </div>
                <div class="inputCell" style="width: 24%;">
                    <p style="width: 45%;"><i>*</i> 中文描述：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.descript" placeholder="请输入内容" style="width: 50%;"></el-input>
                </div>
                <div class="inputCell" style="width: 24%;">
                    <p style="width: 45%;"> <i>*</i>英文描述：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.descript_en" placeholder="请输入内容" style="width: 50%;"></el-input>
                </div>
                <div class="inputCell" style="width: 24%;">
                    <p style="width: 45%;"> 会员计划：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="tabsDetailData.descript" placeholder="请输入内容" disabled style="width: 50%;"></el-input>
                ...
                <div class="inputCell" style="width: 24%;">
                    ...
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.no_show_point" placeholder="请输入内容" style="width: 45%;"></el-input>
                </div>
                <div class="inputCell" style="width: 24%;">
                    <p style="width: 45%;"> 积分使用限制：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.point_use_limit" placeholder="请输入内容" style="width: 45%;"></el-input>
                </div>
                <div class="inputCell" style="width: 24%;">
                ...
                <div v-show="CertainCardLevelJson.is_special_card_rule" class="inputCell" style="width: 24%;">
                    ...
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.special_card_rule" placeholder="请输入内容" disabled style="width: 45%;"></el-input>
                </div>
                <div class="inputCell" style="width: 50%;">
                    <p style="width: 21%;"> 备注：</p>
                    <!-- 查询input -->
                    <el-input size="mini" type="textarea" v-model="CertainCardLevelJson.remark" placeholder="请输入内容"  style="width: 50%;"></el-input>
                </div>
                </div>
                <!-- 右侧卡等级图片 -->
              ...
              <div class="classMes" style="padding: 10px 20px;">
                <div class="inputCell" >
                    <p > 首充>=：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.first_pay_min" placeholder="请输入内容" style="width: 500px;"></el-input>
                </div>
                <div class="inputCell" >
                    <p > 续充>=：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.continue_pay_min" placeholder="请输入内容" style="width: 500px;"></el-input>
                </div>
                <div class="inputCell" >
                    <p> 累计充值>=：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.limit_balance" placeholder="请输入内容" style="width: 500px;"></el-input>
                </div>
                <div class="inputCell">
                    <p> 提醒充值余额：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.limit_balance" disabled placeholder="请输入内容" style="width: 500px;"></el-input>
                </div>
              </div>
            ...
            <el-dialog
              ...
              <div class="innerDialog">
                <div class="inputCell" style="width: 80%;">
                    ...
                    <!-- 查询input -->
                    <el-input size="mini" v-model="Rules_pre" placeholder="请输入内容" style="width: 50%;"></el-input>
                    <p> (不填代表无前缀）</p>
                </div>
                <div class="inputCell" style="width: 80%;">
                    <p style="width: 20%;"> 卡号后缀：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="Rules_last" placeholder="请输入内容" style="width: 50%;"></el-input>
                    <p> (不填代表无后缀）</p>
                </div>
                <div class="inputCell" style="width: 80%;">
                    <p style="width: 20%;"> 序号长度：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="Rules_length" maxlength="20" placeholder="请输入内容" style="width: 50%;"></el-input>
                </div>
              </div>
              <!-- 取消删除保存 -->
            ...
            <el-dialog
              ...
              <div class="innerDialog">
                <div class="inputCell">
                    ...
                    <!-- 查询input -->
                    <el-input size="mini" v-model="tabsDetailData.descript " placeholder="请输入内容" disabled style="width: 60%;"></el-input>
                </div>
                <div class="inputCell">
                    <p style="width: 30%;"> 会员等级：</p>
                    <!-- 查询input -->
                    <el-input size="mini" v-model="CertainCardLevelJson.descript" placeholder="请输入内容 " disabled style="width: 60%;"></el-input>
                </div>
                <div class="inputCell" >
                    <p style="width: 30%;"> 扩展项目：</p>
                    <!-- 查询input -->
                    <!-- <el-input size="mini" v-model="ExtraItemJson.extra_item" placeholder="请输入内容" style="width: 60%;"></el-input> -->
                    <el-select size="mini" v-model="ExtraItemJson.extra_item" placeholder="请选择" style="width: 60%;">
                      <el-option
                ...
                <div class="inputCell">
                    ...
                    <el-select v-if=" ExtraItemJson.extra_item ==  'rate_code'"  size="mini" v-model="ExtraItemJson.extra_item_value" placeholder="请选择" style="width: 60%;" @focus="get_rate_code_data()">
                      <el-option
                        v-for="item in rateCodeArr"
                        :key="item.code"
                        :label="item.description"
                        :value="item.code">
                      </el-option>
                    </el-select>
                    <el-input v-else size="mini" v-model="ExtraItemJson.extra_item_value" placeholder="请输入内容" style="width: 60%;"></el-input>
                </div>
                <div class="inputCell">
             ...
             axios.get(url).then(function(res) {
               if(res.data.message=="success"){ 
                 if(res.data.data.results.length){ 
                    that.rateCodeArr = res.data.data.results
                 }  
               }else{
