            ...
            <div class="outdialog">
              <!-- 单条内层 -->
                ...
                <div v-if=" CertainPromotion.trigger_way == 'card_charge' " class="innerbox">
                    <div class="inner pull-left">
                        <p>最小充值金额：</p>
                        <el-input v-model=" charge_form.min_pay " placeholder="请输入内容" style="width: 70%;"></el-input>
                    </div>
                    <div class="inner pull-right">
                        <p>最大充值金额：</p>
                        <el-input v-model=" charge_form.max_pay " placeholder="请输入内容" style="width: 70%;"></el-input>
                    </div>
                </div>
                <!-- 单条内层 --> 
                <div v-if=" CertainPromotion.trigger_way == 'card_charge' "  class="innerbox">
