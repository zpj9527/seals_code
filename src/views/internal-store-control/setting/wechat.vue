<template>
  <div class="wechat">
    <div class="head" style="width: 100%;margin-bottom: 10px">
      <i class="el-icon-setting" style="color:#777777FF"></i>
      <span
        style="vertical-align: top;display: inline-block;margin-left: 10px;margin-right: 10px;font-size: 16px">支付配置</span>
    </div>
    <!--支付方式 -->
    <div class="shopping">
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="微信配置" name="first">
          <div class="head" style="width: 100%;margin-bottom: 10px">
            <el-button type="primary" @click="dialogVisible = true;flush();classes_add()" class="btn"
                       :disabled="isDisabled" style="width: 80px;height: 24px;line-height: 1px;margin-top:4px;"
          ...
          <el-dialog
            ...
            <ul class="dialog_style">
              <li>
                ...
                <span>类型 ：</span>
                <el-select v-model="pub_usage" placeholder="请选择" style="width: 220px;" size="mini"
                           @change="wechat_click">
                  <el-option
              ...
              <li>
                <i style="color: red;font-size: 18px">*</i>
                <span>名称 ：</span>
                <el-input v-model="param.name" placeholder="请输入名称" clearable style="width: 220px;"
                          size="mini"></el-input>
              </li>
              <li>
                <i style="color: red;font-size: 18px">*</i>
              ...
              <template v-else>
                ...
                <li>
                  ...
                  <el-input v-model="param.pub_app_secret" placeholder="请输入公众号app_secret" style="width: 220px;"
        ...
        <el-tab-pane label="支付宝配置" name="second"></el-tab-pane>
      </el-tabs>
