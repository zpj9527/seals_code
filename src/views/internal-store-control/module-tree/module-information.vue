  ...
  <div class="information">
    ...
    <div class="masking" v-show="masking">
      <ul class="mask_information">
        ...
        <li><span>英文描述</span>
          <el-input v-model="desc_en" placeholder="请输入内容" style="width: 217px;"></el-input>
        </li>
        <li><span>模块代码</span>
          <el-input v-model="code" placeholder="请输入内容" style="width: 217px;"></el-input>
        </li>
        <li>
          <span>模块种类</span>
        ...
        <li><span>链接</span>
          <el-input v-model="url" placeholder="请输入内容" style="width: 217px;"></el-input>
        </li>
        ...
        <li><span>版本号</span>
          <el-input v-model="input" placeholder="1.0" style="width: 217px;" :disabled="true"></el-input>
        </li>
        ...
        <li style="margin-top:50px;">
          ...
          <button @click="abolish">取消</button>
        </li>
  ...
  export default {
    ...
    methods: {
      ...
      preserve() {
        ...
        this.$axios({
          url: "" + this.url + "/v1/common/module/update/" + this.id,
          method: "post",
          // params:{},
          data: {
            name: this.name,
      ...
      cancel(id, index, list) {
        ...
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          list.splice(index, 1);
          this.$axios({
            url: "" + this.url + "/v1/common/module/remove/" + id,
            method: "post",
            // params:{},
            // data:{},
            //headers: {'authorization': this.authorization_token}
