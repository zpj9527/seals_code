<template>
  <div class="audit_management">
    ...
    <div class="shopping">
      <span
        style="vertical-align: top;display: inline-block;line-height: 35px;padding:10px;font-weight: bold">人员异常考勤表</span>
      <ul style="margin-bottom: 10px;">
        <li>
          <span>人员:</span>
          <el-select v-model="user_id" clearable placeholder="请选择人员搜索" size="mini" @change="search"
                     style="width: 150px;">
            <el-option
  ...
  export default {
    ...
    methods: {
      ...
      enter_code() {
        let that = this
        that.$axios({
          url: that.url + "/v1/manage/duty_abnormal/hotel_abnormals",
          method: "get",
          params: {
