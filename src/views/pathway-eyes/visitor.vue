    ...
    <el-dialog
      ...
      <ul class="dialog_style">
        ...
        <li style="position: relative">
          ...
          <!--assets/images/tasksystem/tasks/camera.png-->
          <!--图片展示-->
          <img src="../../../src/assets/images/tasksystem/tasks/camera.png" alt=""  ref="img"
      ...
      methods: {
            ...
            .then(res => {
              if (res.data.message === "success") {
                ...
                for (let item of res.data.data.list) {
                  item.head_img_id = "https://ispider-oss.oss-cn-hangzhou.aliyuncs.com/"+ item.head_img_id
        ...
        photograph () {
          ...
          if(imgBase64){
            ...
            let url = ' https://oss.crowncrystalhotel.com/resource/visitor/upload';
            that.$axios.post(url,fd,config).then(res=>{
              console.info(res);
              that.img_id = res.data.url;
